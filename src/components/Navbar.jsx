  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10'>
        <div className='container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent'>
            ...
            <button className='hidden md:block bg-white px-8 py-2 rounded-full hover:scale-105 transition-all duration-300'>
                Sign Up
            </button>
            ...
            {/*-------------------- Mobile Menu------------ */}
            <div className={`md:hidden ${showMenu ? ' fixed w-full' : 'h-0 w-0'} right-0 top-0 bottom-0 overflow-hidden bg-white
            transition-all`}>

              <div className='flex justify-end p-6'>
                <img src={assets.cross_icon} className='w-6 cursor-pointer'
